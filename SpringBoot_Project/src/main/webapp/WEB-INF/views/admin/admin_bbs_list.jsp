   ...
   <form method="get" action="admin_bbs_list">
		<div id="bList_wrap">
						...
						<tr>
							...
							<td>
								...
								<a href="admin_bbs_cont?no=${b.bbs_no}&page=${page}&state=cont">
									...
									<c:if test="${fn:length(b.bbs_title)<16}">${b.bbs_title}</c:if>
								</a>
							</td>
							...
							<td align="center"><input type="button" value="수정"
								...
								<%-- 
									confirm() 자바스크립트 함수(메서드)는 삭제 유무를 판단하는 확인/취소 버튼을 가진 경고창을 만들어 준다.확인을 클릭하면 true,
									취소를 클릭하면 false를 반환 
								--%>
							</td>
						</tr>
			...
			<div id="bFind_wrap">
				...
				<input name="find_name" id="find_name" size="14" value="${find_name}" /> <input type="submit" value="검색" />
			</div>
		</div>
	</form>
</div>
